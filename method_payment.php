...
<body>
  ...
  <div id="page">
    ...
    <header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(images/bg_payment2.jpg);">
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <h2 align="center">ขั้นตอนการชำระเงิน</h2>
          <img class="img-responsive" src="images/patment.png" alt="" width="1280" height="480" align="center">
        </div>
      </div>
    </div>
