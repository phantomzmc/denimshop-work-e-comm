		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(images/nudie_1.jpg);">
							<div class="inner">
								<p>
						...
						<div class="desc">
							<h3><a href="single.html">Nudie Jeans : Lean Dean & Grim Tim Dry Bamboo Selvage. </a></h3>
							<span class="price">6900 Bath</span>
						</div>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(images/nudie_2.jpg);">
						...
						<div class="desc">
							<h3><a href="single.html">Nudie Jeans : Grim Tim & Lean Dean Dry Paper Selvage. </a></h3>
							<span class="price">6900 Bath</span>
						</div>
					</div>
				</div>
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(images/nudie_3.jpg);">
							<div class="inner">
								<p>
									<a href="single.html" class="icon"><i class="icon-shopping-cart"></i></a>
									<a href="single.html" class="icon"><i class="icon-eye"></i></a>
						...
						<div class="desc">
							<h3><a href="single.html">Nudie Jeans : Lean Dean & Grim Tim Dry Hemp Selvage. </a></h3>
							<span class="price">6500 Bath</span>
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(images/nudie_4.jpg);">
							<div class="inner">
								<p>
									<a href="single.html" class="icon"><i class="icon-shopping-cart"></i></a>
									<a href="single.html" class="icon"><i class="icon-eye"></i></a>
						...
						<div class="desc">
							<h3><a href="single.html">Nudie Jeans : Billy Dry Hemp Selvage</a></h3>
							<span class="price">7200 Bath</span>
						</div>
					</div>
				</div>
				<!-- <div class="col-md-4 text-center animate-box">
